      ...
      <section className={`${style.portfolioSection} globalSection`}>
        <div className={style.container}>
          <h2 className={style.homeTitle}>
            ...
            <strong> funcionalidade</strong> e <strong>qualidade de vida.</strong>
          </h2>
        ...
        <div className={style.servicosContainer}>
          <div className={style.card}>
            ...
            <p className={style.cardText}>
              Desenvolvimento completo do projeto da edificação, incluindo planta
              baixa, cortes, fachadas e detalhamentos técnicos.
            </p>
          </div>
          ...
          <div className={style.card}>
            ...
            <p className={style.cardText}>
              Escolha de mobiliário, iluminação, cores e materiais para transformar
              ambientes internos de forma funcional e estética.
            </p>
          </div>
